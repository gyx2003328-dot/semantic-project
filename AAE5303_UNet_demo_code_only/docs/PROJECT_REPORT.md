...
- 生成时间：2026-04-10 11:40:40
- 任务类型：语义分割（UNet）
- 数据划分：Train/Val/Test = 3153/556/1380
- 类别数量：15
...
```bash
bash scripts/run_pipeline.sh eval --model checkpoints/checkpoint_epoch30.pth
```
...
## 7. 各类别表现
- ground: IoU=81.47%, Dice=89.79%, Frequency=18.93%
- roof: IoU=92.08%, Dice=95.87%, Frequency=9.35%
- building: IoU=85.92%, Dice=92.43%, Frequency=3.86%
- class_3: IoU=94.63%, Dice=97.24%, Frequency=1.5%
- class_5: IoU=78.57%, Dice=88.0%, Frequency=0.0%
- class_6: IoU=74.5%, Dice=85.39%, Frequency=0.02%
- green_field: IoU=95.84%, Dice=97.88%, Frequency=61.31%
- wild_field: IoU=91.87%, Dice=95.76%, Frequency=3.39%
- class_15: IoU=91.91%, Dice=95.79%, Frequency=0.1%
- class_16: IoU=70.31%, Dice=82.57%, Frequency=0.0%
- class_17: IoU=91.43%, Dice=95.52%, Frequency=0.35%
- class_19: IoU=95.89%, Dice=97.9%, Frequency=0.97%
- sedan: IoU=65.7%, Dice=79.3%, Frequency=0.16%
- class_24: IoU=63.83%, Dice=77.92%, Frequency=0.04%
- class_25: IoU=43.29%, Dice=60.42%, Frequency=0.0%

## 8. 训练历史摘要
- 训练 epoch 数：30
- 最终 train loss：0.0855
- 最终 val dice：0.9103
